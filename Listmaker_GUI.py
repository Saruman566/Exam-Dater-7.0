...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionNoten_Liste = QAction(MainWindow)
        self.actionNoten_Liste.setObjectName(u"actionNoten_Liste")
        ...
        self.Show_window3.setFont(font1)
...
"")
        ...
        self.themen_label.setFont(font1)
        ...
        self.lehrer_label.setFont(font1)
...
"background-color: rgb(85, 255, 255);")
        ...
        self.menuListmaker = QMenu(self.menuBar)
        self.menuListmaker.setObjectName(u"menuListmaker")
        MainWindow.setMenuBar(self.menuBar)

        self.menuBar.addAction(self.menuListmaker.menuAction())
        self.menuListmaker.addAction(self.actionListmaker)
        self.menuListmaker.addSeparator()
        self.menuListmaker.addAction(self.actionNoten_Liste)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNoten_Liste.setText(QCoreApplication.translate("MainWindow", u"Noten-Liste", None))
        self.btn_teacher.setText(QCoreApplication.translate("MainWindow", u"Lehrer", None))
        self.save_button.setText("")
        self.themes_del_button.setText("")
        self.teacher_del_button.setText("")
        self.themen_label.setText("")
        self.btn_themen.setText(QCoreApplication.translate("MainWindow", u"Themen", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"   Datum   ", None));
        ___qtablewidgetitem2 = self.date_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"      Lehrer     ", None));
        ___qtablewidgetitem3 = self.date_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Thema", None));
        self.menuListmaker.setTitle(QCoreApplication.translate("MainWindow", u"Listmaker", None))
    # retranslateUi
